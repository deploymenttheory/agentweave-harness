...
(signals, rules, rate limits, egress, transparency, …) is currently documented
in windows-mcp-server's `docs/policy-config.md`; that document migrates here at
Phase 7. This one covers what the harness adds on top.
